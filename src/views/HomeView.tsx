    ...
    <div id="home-page-container" className="space-y-16 sm:space-y-24">
      ...
      <section id="featured-books-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <RevealOnScroll direction="up">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
            <div>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0B192C]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {featuredBooks.slice(0, 8).map((book, idx) => (
            <RevealOnScroll key={book.id} direction="up" delay={idx * 0.08}>
              <BookCard book={book} />
            </RevealOnScroll>
          ))}
        </div>
      ...
      {spotlightBook && (
        <section id="editorial-spotlight-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <RevealOnScroll direction="scale" duration={0.65}>
      ...
      <section id="why-sahayak-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <RevealOnScroll direction="up">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0B192C] mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {[
            ...
            return (
              <RevealOnScroll key={idx} direction="up" delay={idx * 0.07}>
                <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm hover:shadow-md transition-shadow text-center flex flex-col items-center h-full">
            ...
            {authors.slice(0, 4).map((author, idx) => (
              <RevealOnScroll key={author.id} direction="up" delay={idx * 0.08}>
                <div
                  ...
                  className="group bg-white rounded-2xl p-6 border border-stone-200/80 hover:border-[#C5A059] shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer flex flex-col justify-between h-full"
                >
      ...
      <section id="reader-reviews-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.filter((r) => r.featured).slice(0, 3).map((rev, idx) => (
            <RevealOnScroll key={rev.id} direction="up" delay={idx * 0.1}>
              <div className="bg-white rounded-2xl p-6 sm:p-7 border border-stone-200 shadow-sm flex flex-col justify-between relative h-full">
                <div>
                  {/* Rating stars */}
